// Общие
export const SELECTOR_TITLE = '.login-form__title';
export const SELECTOR_EMAIL_INPUT = 'input[name="email"]';
...
export const SELECTOR_PASS_CLEAR_BTN = '.login-form__fields>[name="password"] button.ui-input__remove-btn';        
export const SELECTOR_SHOW_HIDDEN_PASS_BTN = 'button.ui-input-password__button';
export const SELECTOR_ERR_NOTIFY = '.base-notify--error .base-notify__text'; 

// Модалка
export const SELECTOR_CLOSE_MODAL_BTN = '.base-modal__close-button';

// Страница
export const SELECTOR_PAGE_IMAGE = 'form.login-form img';